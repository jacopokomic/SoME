...
class Cell6(m.Scene):
    def construct(self):
        ...
        title = m.Tex("Monthly Income, Debt Ratio, Total Debt").move_to(3.5*m.UP)
...
class Cell7(m.Scene):
    def construct(self):
        ...
        title = m.Tex("Number Of Times X Days Past Due").move_to(3.5*m.UP)
...
class Cell14(m.Scene):
    def construct(self):
        ...
        late6089 = m.Tex("60-89 Days Late").scale(0.8).move_to(layout[10] + 1.5*m.LEFT)
...
class Cell19(m.Scene):
    def construct(self):
        ...
        late6089 = m.Tex("60-89 Days Late").scale(0.8).move_to(2.8*m.DOWN + 5.5*m.LEFT)
...
class Cell21(m.Scene):
    def construct(self):
        ...
        best = m.Tex("best achieved accuracy: 86.71\\%").move_to(0.5*m.DOWN)
